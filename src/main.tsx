...
ReactDOM.createRoot(document.getElementById('root')!).render(
  <UnifiedWalletProvider
    ...
    config={{
      ...
      metadata: {
        name: "Waterdrop '88",
        description: "An 80s‑themed, tech‑powered, sacred‑water fundraiser",
        url: window.location.origin,
        iconUrls: ["https://cseas.fun/assets/waterdrop-icon.png"], // Update with your icon
      },
